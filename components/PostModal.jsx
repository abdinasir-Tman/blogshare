  ...
  return (
    <div>
      <Modal
        ...
        className="shadow-lg fixed bg-white p-4 rounded-md top-0  left-0 right-0 md:right-12 md:left-12 md:top-12 lg:left-20 lg:right-20 lg:top-20 lg:bottom-20 bottom-0"
      >
        {/* <h2
